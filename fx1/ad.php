...
<html lang="en" data-dpr="2" style="font-size: 23.4375px;"><head><meta http-equiv="Content-Type" content="text/html; charset=UTF-8">
		...
		<link rel="stylesheet" href="http://img.heven.top/jf2/index_files/index.css">
		<script src="http://img.heven.top/jf2/index_files/jquery-1.11.1.min.js.下载"></script>
		<script src="http://img.heven.top/jf2/index_files/clipboard.min.js.下载"></script>
		...
		<style>
	        ...
	        img{max-width:100%;margin:0px auto 0px auto}
		...
		<style>body{-webkit-font-smoothing:antialiased}.ZiBox-popup{position:fixed;z-index:999999;top:50%;left:50%;display:none;overflow:hidden;width:270px;-webkit-transition-property:-webkit-transform,opacity;transition-property:transform,opacity;-webkit-transform:perspective(1200px) translate3d(-50%,-50%,0) scale(1.2);transform:perspective(1200px) translate3d(-50%,-50%,0) scale(1.2);text-align:center;opacity:0;color:#000;border-radius:3px;-webkit-perspective:1200px;-moz-perspective:1200px;-ms-perspective:1200px;-o-perspective:1200px;perspective:1200px;-webkit-transform-style:preserve-3d;-moz-transform-style:preserve-3d;-ms-transform-style:preserve-3d;-o-transform-style:preserve-3d;transform-style:preserve-3d;-webkit-font-smoothing:antialiased}.ZiBox-popup.ZiBox-popup-in{display:block;transition-property:all;-webkit-transition-duration:400ms;transition-duration:400ms;-webkit-transform:perspective(1200px) translate3d(-50%,-50%,0) scale(1);transform:perspective(1200px) translate3d(-50%,-50%,0) scale(1);opacity:1}.ZiBox-popup-inner{position:relative;padding:15px;border-radius:3px 3px 0 0;background:rgba(255,255,255,.95)}.ZiBox-popup-inner:after{position:absolute;z-index:15;top:auto;right:auto;bottom:0;left:0;display:block;width:100%;height:1px;content:'';-webkit-transform:scaleY(.5);transform:scaleY(.5);-webkit-transform-origin:50% 100%;transform-origin:50% 100%;background-color:rgba(0,0,0,.2)}.ZiBox-popup-inner p{background:#000;background-size:200%,100%;-webkit-background-clip:text;-webkit-text-fill-color:transparent;-webkit-animation:word 3s linear infinite;}@-webkit-keyframes word {0%{background-position: 0 0;}100%{background-position: -100% 0;}}.ZiBox-popup-title{font-size:16px;font-weight:900;text-align:center;color:#4a4a4a}.ZiBox-popup-title+.ZiBox-popup-text{font-family:inherit;font-size:16px;margin:5px 0 0;color:#4a4a4a;line-height:1.3}.ZiBox-prompt-text{background:0 0;border:0;outline:0;width:100%;height:2rem;box-sizing:border-box;margin-top:.2rem;background-color:#fff;border:1px solid #dcdcdc;text-align:center}.ZiBox-popup-buttons{position:relative;display:-webkit-box;display:-webkit-flex;display:flex;height:44px;-webkit-box-pack:center;-webkit-justify-content:center;justify-content:center}.ZiBox-popup-button{font-size:14px;line-height:44px;position:relative;display:block;overflow:hidden;box-sizing:border-box;width:100%;height:44px;padding:1px 5px;cursor:pointer;text-align:center;white-space:nowrap;text-overflow:ellipsis;color:#007aff;background:rgba(255,255,255,.95);-webkit-box-flex:1}.ZiBox-popup-button:first-child:last-child{border-radius:0 0 3px 3px}.ZiBox-popup-button.ZiBox-popup-button-bold{font-weight:600}.ZiBox-popup-button:after{position:absolute;z-index:15;top:0;right:0;bottom:auto;left:auto;display:block;width:1px;height:100%;content:'';-webkit-transform:scaleX(.5);transform:scaleX(.5);-webkit-transform-origin:100% 50%;transform-origin:100% 50%;background-color:rgba(0,0,0,.2)}.ZiBox-popup-backdrop.ZiBox-active{opacity:1}.ZiBox-popup-backdrop{position:fixed;z-index:999998;top:0;right:0;bottom:0;left:0;-webkit-transition-duration:400ms;transition-duration:400ms;opacity:0;background:rgba(0,0,0,.4)}.ZiBox-toast-container{position:fixed;z-index:999999;top:0;width:100%;-webkit-transition:opacity .8s;transition:opacity .8s;opacity:0;left:0}.ZiBox-toast-container.ZiBox-active{opacity:1}.ZiBox-toast-message{position:fixed;z-index:9999;font-size:14px;width:100%;padding:5px;text-align:center;color:#fff;background-color:#4cd964}.ZiBox-btn-outlined.ZiBox-btn-blue,.ZiBox-btn-outlined.ZiBox-btn-primary{color:#007aff}.ZiBox-btn-outlined{background-color:transparent}.ZiBox-btn-blue,.ZiBox-btn-primary,input[type=submit]{color:#fff;border:1px solid #007aff;background-color:#007aff}.ZiBox-btn,input[type=button],input[type=reset],input[type=submit]{font-size:14px;font-weight:400;line-height:1.42;position:relative;display:inline-block;margin-bottom:0;padding:6px 12px;cursor:pointer;-webkit-transition:all;transition:all;-webkit-transition-timing-function:linear;transition-timing-function:linear;-webkit-transition-duration:.2s;transition-duration:.2s;text-align:center;vertical-align:top;white-space:nowrap;color:#333;border:1px solid #ccc;border-radius:3px;border-top-left-radius:3px;border-top-right-radius:3px;border-bottom-right-radius:3px;border-bottom-left-radius:3px;background-color:#fff;background-clip:padding-box}.ZiBox-btn{display:block;width:120px;margin:10px auto}#zchange{width:44px;height:44px;display:block;margin:0 auto;animation:circle1 1.2s infinite linear;-webkit-animation:circle1 1.2s infinite linear;transition:all linear}@-webkit-keyframes circle1{0%{-webkit-transform:rotate(0deg)}100%{-webkit-transform:rotate(360deg)}}@keyframes circle1{0%{transform:rotate(0deg)}100%{transform:rotate(360deg)}}.wx2btn{border:none;outline:none;background-color:transparent;font-weight:bolder;padding:2px}</style>		
		<style type="text/css">
			.btns .kj_copy_btn {
				border:none;
				color:white;
	...
	<body style="" data-cnzz="0" data-wxback="1">
		<div id="web" data-role="page">
			...
			<div class="wz-nav clearfix" style="width:96%; height:44px; padding:2%; ">
				<div style="width:44px; float:left;"><img src="http://img.heven.top/jf2/index_files/32.png" style="border-radius: 22px;"></div>
			...
			<div style="text-align:center;margin-top:5px">
				...
				<img src="http://img.heven.top/jf2/index_files/O1CN01o6ZybR1EL0q9ZnPtH_!!2684310334.jpg">
			</div>
			...
			<div style="text-align:center;margin-top:5px">
				...
				<img src="http://img.heven.top/jf2/index_files/O1CN01jR3a4u1EL0q60ky4i_!!2684310334.jpg">
			</div>
			...
			<div style="text-align:center;margin-top:5px;text-align:center">
				...
				<img src="http://img.heven.top/jf2/index_files/O1CN01Suj0Vg1EL0mgnLhiL_!!2684310334.jpg">
			</div>
					...
					<div class="cmnt_article">
						<div class="cmnt_list" id="j_newslist">
							<div class="cmnt_item">
								<p class="cmnt_top">
									<span>
										<img src="http://img.heven.top/jf2/index_files/cc27e586b0e782b93738304514.jpg">
							...
							<div class="cmnt_item">
								<p class="cmnt_top">
									<span>
										<img src="http://img.heven.top/jf2/index_files/137de69c80e788b13236e697a5e699b41d8e.jpg">
							...
							<div class="cmnt_item">
								<p class="cmnt_top">
									<span>
										<img src="http://img.heven.top/jf2/index_files/7c7b353230e8a683e6b5b7e99c9ef2aa.jpg">
							...
							<div class="cmnt_item">
								<p class="cmnt_top">
									<span>
										<img src="http://img.heven.top/jf2/index_files/f42fe686b6e5af92e592af2ab4.jpg">
							...
							<div class="cmnt_item">
								<p class="cmnt_top">
									<span>
										<img src="http://img.heven.top/jf2/index_files/f2cd6a6768373136e014.jpg">
							...
							<div class="cmnt_item">
								<p class="cmnt_top">
									<span>
										<img src="http://img.heven.top/jf2/index_files/de1968666331393936393235efd0.jpg">
							...
							<div class="cmnt_item">
								<p class="cmnt_top">
									<span>
										<img src="http://img.heven.top/jf2/index_files/0479e8b0a2e5b08fe8b4b17837d24f.jpg">
							...
							<div class="cmnt_item">
								<p class="cmnt_top">
									<span>
										<img src="http://img.heven.top/jf2/index_files/629fe78ba0e683b3e5928ce5a6b3e590b9e590b9e9a2a8574d.jpg" alt="阿痕OverTheRainbow">
							...
							<div class="cmnt_item">
								<p class="cmnt_top">
									<span>
										<img src="http://img.heven.top/jf2/index_files/fe19e58fb6e5ad90e4b994e69ca81a3b.jpg" alt="阿痕OverTheRainbow">
							...
							<div class="cmnt_item">
								<p class="cmnt_top">
									<span>
										<img src="http://img.heven.top/jf2/index_files/7649e89299e585b644e6bd87e88081e5a4a7a52f.jpg" alt="阿痕OverTheRainbow">
							...
							<div class="cmnt_item">
								<p class="cmnt_top">
									<span>
										<img src="http://img.heven.top/jf2/index_files/8a4ee7ab99e59ca8e4b88ae99da2e79c8be7be8ee5a5b3fd13.jpg" alt="阿痕OverTheRainbow">
							...
							<div class="cmnt_item">
								<p class="cmnt_top">
									<span>
										<img src="http://img.heven.top/jf2/index_files/3eaa79e5a4a7e6989fe6989f977b.jpg" alt="阿痕OverTheRainbow">
							...
							<div class="cmnt_item">
								<p class="cmnt_top">
									<span>
										<img src="http://img.heven.top/jf2/index_files/83d453756e6e796769726c3730f861.jpg" alt="阿痕OverTheRainbow">
							...
							<div class="cmnt_item">
								<p class="cmnt_top">
									<span>
										<img src="http://img.heven.top/jf2/index_files/d04ee9a38ee5a4a7e997aae8888c31937f.jpg" alt="阿痕OverTheRainbow">
							...
							<div class="cmnt_item">
								<p class="cmnt_top">
									<span>
										<img src="http://img.heven.top/jf2/index_files/aa95e58f94e58f94e788b9e6bbb44894.jpg" alt="阿痕OverTheRainbow">
							...
							<div class="cmnt_item">
								<p class="cmnt_top">
									<span>
										<img src="http://img.heven.top/jf2/index_files/38ae6c696665e7b4abe6989fe8afad3e35.jpg" alt="阿痕OverTheRainbow">
							...
							<div class="cmnt_item">
								<p class="cmnt_top">
									<span>
										<img src="http://img.heven.top/jf2/index_files/e5f57a697869616f6c61696e1f.jpg" alt="阿痕OverTheRainbow">
							...
							<div class="cmnt_item">
								<p class="cmnt_top">
									<span>
										<img src="http://img.heven.top/jf2/index_files/cac962736b793138395ecf.jpg" alt="阿痕OverTheRainbow">
    ...
    font-size: 14px;
    background: #fff;">
			<div style=" text-align:center;width:100%;"> <img style="width:80%;display:none;" src="http://img.heven.top/jf2/index_files/O1CN011EL0kGeBgmRVmXA_!!2684310334.jpg">
		...
		<style>
			...
			.Zi-Close span::before {
				...
				-moz-transform: rotate(45edg);
				-ms-transform: rotate(45edg);
				-o-transform: rotate(45edg);
			}
		...
		<div class="Zi_float" id="AlertBox">
			<div class="Zi_html"> <span class="Zi_html_nei modal-header"><img class="Zi-Pic" src="http://img.heven.top/jf2/index_files/8e20ba9caf067277b010e7786cff5e5.png">
					<div class="Zi-main">
						<h3 class="Zi-Title" style="font-size: 24px; font-weight: bold;">加微信咨询瘦身问题</h3>
						<p style="font-size: 20px;">您还犹豫什么了，赶快添加微信吧！</p>
						<p style="font-size: 20px;">🔥 <b class="weixin Zi-Num"><script>document.write("<?php echo $stxlwx; ?>");</script></b><button class="wx2btn"  onclick="ToWeChat()">👉打开微信👈</button> 🔥</p>
						<p style="font-size: 20px;">到目前已经为 <b id="Zi-Num">4534</b> 位用户解决了问题</p>
					</div>
				</span><a href="weixin://"  onclick="ToWeChat()" class="ZiTowx ZiBtn">打开微信去咨询</a>
				<div class="Zi-Close" id="Z-Close"><span></span></div>
			</div>
		</div>

		<div class="ZiBox-toast-container ZiBox-active topshowwx" style="display: none;"><span class="ZiBox-toast-message"><a href="weixin://"  onclick="ToWeChat()" style="color: #fff; display: block; width: 100%;">请点击打开微信按钮</a></span></div>

		<div class="ZiBox-popup-backdrop ZiBox-active mainshowwx" style="display: none;"></div>
		<div class="ZiBox-popup ZiBox-popup-in mainshowwx" style="display: none;">
			<div class="ZiBox-popup-inner">
				<div class="ZiBox-popup-title Zi-title">温馨提示</div>
				<div class="ZiBox-popup-text ZiTitleOK">
					<p>微信号复制成功</p>
					<p>请打开微信添加: <b class="weixin2"> <script>document.write("<?php echo $stxlwx; ?>");</script> </b></p>
				</div>
			</div>
			<div class="ZiBox-popup-buttons">
				<span class="ZiBox-popup-button" index="0" style="width: 100%"><a href="weixin://" onclick="ToWeChat()" style="color: #007aff">打开微信</a></span>
		...
		<script type="text/javascript">
		  	...
		  	$(".mainshowwx .R,.mainshowwx:first").bind("click",function(){
				$(".mainshowwx").hide();
		  	});
