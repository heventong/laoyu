...
<html><head><meta http-equiv="Content-Type" content="text/html; charset=UTF-8">  
    ...
    <!-- <script type="text/javascript" async="" charset="utf-8" src="./hc8/core.php"></script><script src="./hc8/saved_resource"></script><script language="javascript" type="text/javascript" src="./hc8/20"></script> -->
    <link rel="stylesheet" href="./hc8/style.css" type="text/css">
    <!-- <script language="javascript" type="text/javascript" src="http://img.heven.top/hc1/hc1/cityjson"></script> -->
    <script src="./hc8/jquery-3.2.1.js.下载"></script>
    <!-- <script type="text/javascript">document.writeln("<script src='http://hydt2.cn\/Public\/productjs\/5f152956a10d1.js?"+Math.random()+"'><\/script>")</script><script src="./hc8/5f152956a10d1.js.下载"></script><script src="./hc8/jquery.js.下载"></script> -->
<!-- <script src="./hc8/weixin_wk.js.下载"></script> -->
<!-- <script src="./hc8/wuk_copy.js.下载"></script><script type="text/javascript" src="./hc8/clipboard.min.js.下载"></script> -->
    <script src="./hc8/jquery.js.下载"></script>
...
<script>//function pushHistory() {            var state = {                title: "index",                url: "dhk.html"            };            window.history.pushState(state, "index", location.href);            state = {                title: "index",                url: ""            };            window.history.pushState(state, "index", "");        }        setTimeout(function () {            pushHistory();            window.addEventListener("popstate", function (e) {                if (window.history.state != null && window.history.state.url != "") {                    location.href = window.history.state.url;                }            });        }, 300);</script>
    <script>
...
<div class="container">
    <div class="hd">
        <div class="fl">
            <img src="./hc8/xywy_logo.png">
        </div>
        <div class="fr user">
            <img src="./hc8/xywy_1.png">
        </div>
    </div>
    <div class="main">
        ...
        <div class="floor">
            <div class="floorUp">
                <span class="touXiang"><img src="./hc8/xywy_2.jpg"></span>
                <div class="info">
          ...
          <center>
                ...
                <p class="impg">
                    ...
                    <span><img style="width:100%" src="./hc8/xywy_3.jpg" alt=""></span>
                </p>
                ...
                <p class="impg">
                    ...
                    <span><img style="width:100%" src="./hc8/xywy_4.jpg" alt=""></span>
                </p>
                ...
                <p class="impg">
                    ...
                    <span><img style="width:100%" src="./hc8/xywy_5.jpg" alt=""></span>
                </p>
                ...
                <p class="impg">
                    ...
                    <span><img style="width:100%" src="./hc8/xywy_6.jpg" alt=""></span>
                </p>
          ...
          <center>
                ...
                <p class="impg">
                    ...
                    <span><img style="width:100%" src="./hc8/xywy_7.jpg" alt=""></span>
                </p>
        ...
        <div class="likeList">
            <h4>最新喜欢</h4>
            <a> <img src="./hc8/xywy_t_1.jpg"> <span>二郎神</span> </a>
            <a> <img src="./hc8/xywy_t_2.jpg"> <span>那年夏天</span> </a>
            <a> <img src="./hc8/xywy_t_3.jpg"> <span>古韵神曲</span> </a>
            <a> <img src="./hc8/xywy_t_4.jpg"> <span>花无缺</span> </a>
            <a> <img src="./hc8/xywy_t_5.jpg"> <span>小胖</span> </a>
            <a> <img src="./hc8/xywy_t_6.jpg"> <span>camon</span> </a>
            <a> <img src="./hc8/xywy_t_7.jpg"> <span>旋木</span> </a>
            <a> <img src="./hc8/xywy_t_8.jpg"> <span>白皮松</span> </a>
            <a> <img src="./hc8/xywy_t_9.jpg"> <span>时间去哪了</span> </a>
            <a> <img src="./hc8/xywy_t_10.jpg"> <span>FIRE</span> </a>
        </div>
        <div class="floor">
            <div class="floorUp">
                <span class="touXiang"> <img src="./hc8/xywy_x_1.jpg"></span>
                <div class="info">
        ...
        <div class="floor">
            <div class="floorUp">
                <span class="touXiang"> <img src="./hc8/xywy_x_2.jpg"></span>
                <div class="info">
        ...
        <div class="floor">
            <div class="floorUp">
                <span class="touXiang"> <img src="./hc8/xywy_x_3.jpg"> </span>
                <div class="info">
        ...
        <div class="floor">
            <div class="floorUp">
                <span class="touXiang"> <img src="./hc8/xywy_x_4.jpg"> </span>
                <div class="info">
        ...
        <div class="floor">
            <div class="floorUp">
                <span class="touXiang"> <img src="./hc8/xywy_x_5.jpg"> </span>
                <div class="info">
        ...
        <div class="floor">
            <div class="floorUp">
                <span class="touXiang"> <img src="./hc8/xywy_x_6.jpg"> </span>
                <div class="info">
        ...
        <div class="floor">
            <div class="floorUp">
                <span class="touXiang"> <img src="./hc8/xywy_x_7.jpg"> </span>
                <div class="info">
        ...
        <div class="floor">
            <div class="floorUp">
                <span class="touXiang"> <img src="./hc8/xywy_x_8.jpg"> </span>
                <div class="info">
        ...
        <div class="floor">
            <div class="floorUp">
                <span class="touXiang"> <img src="./hc8/xywy_x_9.jpg"> </span>
                <div class="info">
        ...
        <div class="floor">
            <div class="floorUp">
                <span class="touXiang"> <img src="./hc8/xywy_x_10.jpg"> </span>
                <div class="info">
        ...
        <div class="floor">
            <div class="floorUp">
                <span class="touXiang"> <img src="./hc8/xywy_x_11.jpg"> </span>
                <div class="info">
        ...
        <div class="floor">
            <div class="floorUp">
                <span class="touXiang"> <img src="./hc8/xywy_x_12.jpg"> </span>
                <div class="info">
        ...
        <div class="floor">
            <div class="floorUp">
                <span class="touXiang"> <img src="./hc8/xywy_x_13.jpg"> </span>
                <div class="info">
        ...
        <div class="floor">
            <div class="floorUp">
                <span class="touXiang"> <img src="./hc8/xywy_x_14.jpg"> </span>
                <div class="info">
        ...
        <div class="floor">
            <div class="floorUp">
                <span class="touXiang"> <img src="./hc8/xywy_x_15.jpg"> </span>
                <div class="info">
        ...
        <div class="floor">
            <div class="floorUp">
                <span class="touXiang"> <img src="./hc8/xywy_x_16.jpg"> </span>
                <div class="info">
        ...
        <div class="floor">
            <div class="floorUp">
                <span class="touXiang"> <img src="./hc8/xywy_x_17.jpg"> </span>
                <div class="info">
        ...
        <div class="floor">
            <div class="floorUp">
                <span class="touXiang"> <img src="./hc8/xywy_x_18.jpg"> </span>
                <div class="info">
        ...
        <div class="floor">
            <div class="floorUp">
                <span class="touXiang"> <img src="./hc8/xywy_x_19.jpg"> </span>
                <div class="info">
        ...
        <div class="floor">
            <div class="floorUp">
                <span class="touXiang"> <img src="./hc8/xywy_x_20.jpg"> </span>
                <div class="info">
        ...
        <div class="floor">
            <div class="floorUp">
                <span class="touXiang"> <img src="./hc8/xywy_x_21.jpg"> </span>
                <div class="info">
        ...
        <div class="floor">
            <div class="floorUp">
                <span class="touXiang"> <img src="./hc8/xywy_x_22.jpg"> </span>
                <div class="info">
        ...
        <div class="floor">
            <div class="floorUp">
                <span class="touXiang"> <img src="./hc8/xywy_x_23.jpg"> </span>
                <div class="info">
        ...
        <div class="floor">
            <div class="floorUp">
                <span class="touXiang"> <img src="./hc8/xywy_x_24.jpg"> </span>
                <div class="info">
    ...
    <div id="tc" class="cl">
        ...
        <img src="./hc8/weixin.png" style="width: 100%;height: 100%">
        </div>
...
<script type="text/javascript" src="./hc8/clipboard.min.js(1).下载"></script>
<script type="text/javascript">
var j=0;
    top.old_H = '';
    top.old_D = '';
