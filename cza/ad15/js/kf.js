var facilitator_id='';
var acc_host='accwww5c1.53kf.com';var companyid='70860308';var hz6d_guest_ip='120.230.116.8';var ipstr='%E5%B9%BF%E4%B8%9C%E7%9C%81%E5%B9%BF%E5%B7%9E%E5%B8%82%5B%E7%A7%BB%E5%8A%A8%5D';var areastr='%E5%B9%BF%E4%B8%9C%2D%E5%B9%BF%E5%B7%9E';var ipContinent='%E4%BA%9A%E6%B4%B2';var in_timestamp='1584431190375';var hz6d_guest_id='10327992965013';var hz6d_style_id= '4';var hz6d_alias_host='http://www5c1.53kf.com';var company_site={};var mnone=0;var hz6d_device='';var get_gdt_openid='0';var kf_sign='DQzMTMTU4NE5MDEwMzI3OTkyOTY1MDEzNzA4NjAzMDg%3D';var cloud_service='';
/* 
    变量：
...
(function(window, undefined) {
	...
	$53.kfextend($53, {
		...
		setCookie: function(key,value,options) {
			...
			try{
				if((facilitator_id == "36" || facilitator_id=="24") && window.localStorage && window.sessionStorage){
...
function hz6d_sendACC() {
   ...
   // 	var kf_time = "$in_timestamp";
	...
	var acc_times = 20000;
	if(cloud_service == "www111" || (hz6d_alias_host.indexOf("www111.53kf.com") !== -1) || companyid == 72211675 || companyid == 72212262 || companyid == 72212337 || companyid == 72212338 || companyid == 72212339 || companyid == 72212341 || companyid == 72087813) acc_times = 1000;
...
$53.data("workers",{"5634804":{"worker_id":"8888","state":0,"bname":"罗兰"},"10140862":{"worker_id":"1592466568@qq.com","state":0,"bname":"陈建梅"},"5645165":{"worker_id":"0081","state":0,"bname":"柳玉晴"},"5594479":{"worker_id":"0086","state":1,"bname":"李佳玲"},"5635122":{"worker_id":"8088","state":0,"bname":"方雯"}});$53.data("groups",{});$53.data("shunt_info",{"shunt_type":"1"});$53.data("area_shunt",{});$53.data("source_shunt",{});$53.data("channel_shunt",{});$53.data("over_flow",{});$53.data("over_flow_schedule",{});$53.data("of_all_worker",{"5634804":{"worker_id":"8888","state":0,"bname":"罗兰"},"10140862":{"worker_id":"1592466568@qq.com","state":0,"bname":"陈建梅"},"5645165":{"worker_id":"0081","state":0,"bname":"柳玉晴"},"5594479":{"worker_id":"0086","state":1,"bname":"李佳玲"},"5635122":{"worker_id":"8088","state":0,"bname":"方雯"}});$53.data("of_groups",{});$53.data("mobileCompanyInfo",{"stop_back":"1","company_logo":"","company_intr":"","company_short":"","mobile_music":"","zdyurl":"","minchat_height":""});$53.data("icon_award",{});$53.data("api_uuid","e2f50a5020bb235c8306173b82989cd3");
$53.setUuid("e2f50a5020bb235c8306173b82989cd3");
if(window.location.href.substr(0,4) != "file"){
(function(window,undefined){
    var head=document.getElementsByTagName("head")[0];
    var kfscript1= document.createElement("script");
    kfscript1.src="http://www5c1.53kf.com/custom/70860308/mobile_icon_70860308_4.js?v=1490893838";
    var done1=false;
    ...
    kfscript2.src="http://www5c1.53kf.com/custom/70860308/mobile_invite_70860308_4.js?v=1490863154";
    var done2=false;
    ...
    kfscript3.src="http://www5c1.53kf.com/js/default/assign_worker_default.js?v=2017080212";
    var done3=false;
    ...
    kfscript4.src="http://www5c1.53kf.com/js/default/mobile_chat_default.js?v=2017080212";
    var done4=false;
...
(function(window,document,talkHost,ipStr,ipContinent,companyId,styleId,undefined){
	...
	*/
	...
	_53_mobile_chat.prototype.forceOpenLnk = function(){
		var _this = this;
		if (hz6d_alias_host.indexOf("www111.53kf.com") !== -1){//品房阁需求 处理
...
var head=document.getElementsByTagName("head")[0];var script=document.createElement("script");script.src="http://www5c1.53kf.com/kf_new.php?arg=9007169&style=4&land_page="+hz6d_land_page+"&from_page="+$53.EN(hz6d_from_page)+"&kf_sign=DQzMTMTU4NE5MDEwMzI3OTkyOTY1MDEzNzA4NjAzMDg%3D&api_uuid=e2f50a5020bb235c8306173b82989cd3&ip_long=2028368904&time="+new Date().getTime();var done=false;script.onload=script.onreadystatechange=function(){if(!done&&(!this.readyState||this.readyState=="loaded"||this.readyState=="complete")){done=true;script.onload=script.onreadystatechange=null;head.removeChild(script);}};head.appendChild(script);
}
