...
<div class="tabu">
    <div class="h_mainNavNew cDGray h_mainNav" id="f-header">
        ...
        <div class="login" id="js_unlogin_box"> <a href="javascript:;">注册</a><a class="f-login" style="cursor:pointer;" id="js_login_btn">登录</a> </div>

        <div class="login" id="js_userInfo_box" style="display: none;"> <span class="cRed"> <span class="user" style="width: 120px;"> <a href="javascript:;" id="js_userInfo_name"></a> </span> </span> <a class="cGray" id="js_login_exit" style="cursor:pointer;">退出</a> </div>
        ...
        <div class="navFind" id="js_search" style="position: relative; z-index: 80;">
            ...
            <div class="f-search-wrap">
                ...
                <div class="text">
                    ...
                    <input type="text" name="keyword" value="银河系中心附近发现中等黑洞">
...
<div class="main">
    ...
    <h2 class="rich_media_title" id="activity-name"> 【精华】7天狂减12斤？神奇粉末全面揭秘！ </h2>
    ...
    <div id="artical_sth" class="clearfix">
        ...
        <div class="share ipad_block" style="z-index:1000;">
            ...
            <div class="bdshare_t bds_tools get-codes-bdshare share-bar-btn1"> <a class="bds_tsina js_content_share_btn" data-type="sina" data-fid="f63db367862"></a> <a class="bds_qzone js_content_share_btn" data-type="qqZone" data-fid="f4bb6c8c080"></a> <a class="bds_twx js_content_share_btn" data-type="weixin" data-fid="f66642afd11"></a> </div>

        </div>

        <div class="box03" id="js_comment_box03" style="display: block;">

            <h5 class="cmt js_commentCount" id="js_commentCount_top"> <span class="ss_none"> <a href="javascript:;" class="js_joinUrl js_peopleNumber" id=""><em class="js_joinNum">23423</em><span>人参与</span></a> </span> <a href="javascript:;" class="js_cmtUrl js_commentNumber" id=""><em class="js_cmtNum">3121</em><span class="ss_none">评论</span></a> </h5>
...
<div class="lbj" style="">
    ...
    <span style="font-weight:700;">小林说</span>：我叫小林，今年28岁，宝妈一名。生孩子前就有点微胖，但体重也还算正常，生下我家琪琪后才发现可怕，体重直飙142，影响到我生活上的一切！从来没想过原来减肥这么简单，喝完当天排出2斤“巨便”，还不腹泻，排完小肚子塌一半，又软又舒服。从那以后1天喝1次，几乎一天瘦一圈，<span style="color:red;">7天就瘦了12斤</span>，体重天天都在掉，原本像山一样高耸的大肚腩平了，腿细了，腰形出来了……短短30天，<span style="color:red;">整整瘦掉40斤</span>，原本干燥的皮肤也变得水润润的，太不可思议了！
    </div>
    ...
    <div style="border:3px dashed #ff0000;    box-sizing: border-box; width:100%;margin:0 auto;border-radius:10px;margin-top:17px;padding:10px;padding-top:15px;">
	
        <p style="font-size:24px;color:#333;font-weight:700;text-align:center;margin-bottom:5px;padding-top:0px;line-height:25px;text-indent:0;">揭开神奇粉末的神秘面纱</p>
    <br>    <p class="pid pint" style="text-indent:2em;">据调查发现：神奇粉末是国内各界医药权威专家根据<span style="color:red;">产后肥胖</span>、<span style="color:red;">中年肥胖</span>、<span style="color:red;">局部肥胖</span>、<span style="color:red;">食物肥胖</span>等肥胖人群减肥需求，经过上千次实验，终于研发出一款减脂排油功效惊人的神奇粉末。</p>
       
       

  
    <video class="video-js vjs-default-skin vjs-fluid" id="zhimei_mp3" poster="https://img.alicdn.com/imgextra/i1/2684310334/O1CN01kmetkK1EL0rGl9kh9_!!2684310334.jpg" style="margin:15px 0 15px 0;" width="100%" preload="metadata" controls="controls" webkit-playsinline="" playsinline="true" data-setup="{}">您的浏览器不支持在线播放视频！
            <source src="https://cloud.video.taobao.com//play/u/2684310334/p/1/e/6/t/1/245486066105.mp4" type="video/mp4">
        </video>

  <!--
    <div class="well well-sm  tcsize80   bgcfff tc7e0f87 ">
      <marquee width="100%" height="50"    direction="up" scrollamount="3">
        <ul id="marquee_ul" class="list-group text-center marquee_ul">
        </ul>
      </marquee>
    </div>
-->
  ...
  <div class="modal-dialog">
    <div class="modal-content">
      <div class="modal-header">
        ...
        <h4 class="modal-title" id="myModalLabel"><b class="tc7e0f87 tcsize130" id="submit_btn1"></b>
        </h4>
      </div>
      <div class="modal-body">
         <div class="text-center  tcsize150 h1"><b>专业减肥老师</b></div>
         <div class="text-center tc7e0f87 tcsize150 h1"><b>1对1的减肥指导</b></div>
         <div class="small" id="h2" style="display: none;">测试完毕，您的分数是多少呢?<div class="animationbig tccc0066">？？？</div><b class="tccc0066 score1"></b><br>我们将保留5分钟<br>请尽快加导师微信以免失效<br>我们还将分析您的一日三餐</div>
...
<p class="tc7e0f87 tcsize80" id="submit_btn3"></p>  
      ...
      <div class="modal-footer text-center">
        ...
        <div id='marquee_t1' style="display: none;">
		
          <div class="text-center  tcsize110 paddingt50">今天已有<b  class="tc7e0f87 marquee_allnum"></b>人进行了测试</div>
          <div class="well well-sm  tcsize80   bgcfff tc7e0f87 ">
            <marquee width="100%" height="50"    direction="up" scrollamount="3">
              <ul id="marquee_ul" class="list-group text-center marquee_ul">
              </ul>
  ...
  <script type="text/javascript">
    ...
    if(navigator.userAgent.match(/(iPhone|iPod|Android|ios)/i)){
      ...
      $("#left_float").css("left",(w-750)/2-133);
      $("#right_float").css("right",(w-750)/2-230);
      $("#left_float").css("top",50);
      $("#right_float").css("top",50);
...
$(window).scroll(function () {
  ...
  if(d==0){
    ...
    $("#left_float").css("top",d);
    $("#right_float").css("top",d);
  }
...
<script type="text/javascript">
  //滚动显示
    var marquee_name="仲媛湘怡颜英真文怡丞秀琴滇萍青蓉妍羽洁玲雨蓉胜红慧琴道芳辰蓉贞颖莉萍正妍琳竣梦丽若美娅清舒玉映蓉长英丽美夕文琳涵燕星善玲宇芳铭倩琴子筱雪旭妍蝾婷怡婷莉颖芹悦芝蓉娅庭夏美娟娟厦洁卷玉欣颖榕嫣晓悦妍婷帮琼昱瑛沂秀祖萍钰琪菊霞雨琼瑞娟丽芳丽瑶文婷友梅曹文玉颖妍如燕芷思丽翠玉庆霞塔娜雪芬秀秀书怡水琼梦茹国英玉萍新妹银玲文霞浩文文芳秋丽春英羽洁小洁慧瑶芝芳美玲盈盈应艳琳爰君茹莉娉纯雪洲裴志丽露露紫琪艳蓉丹洁玲娇卓妍杭英玲丽婷雯梓悦秀娟梓婧雯婧瑶华翠玲锦婷永茹红琼";
    var marquee_x="赵钱孙李周吴郑王冯陈褚卫蒋沈韩杨朱秦尤许何吕施张孔曹严华金魏陶姜戚谢邹喻柏水窦章云苏潘葛奚范彭郎鲁韦昌马苗凤花方俞任袁柳酆鲍史唐费廉岑薛雷贺倪汤滕殷罗毕郝邬安常乐于时傅皮卞齐康伍余元卜顾孟平黄和穆萧尹姚邵湛汪祁毛禹狄米贝明臧计伏成戴谈宋茅庞熊纪舒屈项祝董梁杜阮蓝闵席季麻强贾路娄危江童颜郭梅盛林刁钟徐邱骆高夏蔡田樊胡凌霍虞万支柯昝管卢莫经房裘缪干解应宗丁宣贲邓郁单杭洪包诸左石崔吉钮龚程嵇邢滑裴陆荣翁荀羊於惠甄曲家封芮羿储靳汲邴糜松井段富巫乌焦巴弓牧隗山谷车侯宓蓬全郗班仰秋仲伊宫宁仇栾暴甘钭历戎祖武符刘景詹束龙叶幸司韶郜黎蓟溥印宿白怀蒲邰从鄂索咸籍赖卓蔺屠蒙池乔阳郁胥能苍双闻莘党翟谭贡劳逄姬申扶堵冉宰郦雍卻璩桑桂濮牛寿通边扈燕冀姓浦尚农温别庄晏柴瞿阎充慕连茹习宦艾鱼容向古易慎戈廖庾终暨居衡步都耿满弘匡国文寇广禄阙东欧殳沃利蔚越夔隆师巩厍聂晁勾敖融冷訾辛阚那简饶空曾毋沙乜养鞠须丰巢关蒯相查后荆红游竺权逮盍益桓";
    var marquee_tel1="34578";

    var nowtime=Math.round(new Date().getTime()/1000);//当前时间戳
    ...
    var unix_timestamp =Math.round(date.getTime()/1000);//当天0点时间戳

    var marquee_allnum1=Math.round((nowtime-unix_timestamp)/2);
   

     $('.marquee_allnum').html(" "+marquee_allnum1+"  ");

     $('.surplus_num').html(" "+(marquee_allnum1)+"  ");
    ...
    for (var i=0;i<200;i++)
    {
      var length_x=marquee_x.length-1;
      var length_name=marquee_name.length-1;
      var length_tel1=marquee_tel1.length-1;

      var index1 = GetRandomNum(1,length_x);  
      var index2 = GetRandomNum(1,length_name);
      var index3 = GetRandomNum(1,length_tel1);
      var index4 = GetRandomNum(0,9); 
      var index5 = GetRandomNum(0,9); 
      var index6 = GetRandomNum(0,9); 
      var index7 = GetRandomNum(0,9);
      var index8 = GetRandomNum(0,9);
      var index9 = GetRandomNum(1,5);
      var score = GetRandomNum(1,9)*10;//得分

      var marquee_x1=marquee_x.substring(index1,index1+1);
      var marquee_name1=marquee_name.substring(index2,index2+1);
      var marquee_tel2=marquee_tel1.substring(index3,index3+1);

      //var unixTimestamp = new Date((nowtime-index9*i)*1000);
      ...
      var commonTime ="  "+num_+"分钟前 ";



      $(".marquee_ul").append("<li>"+marquee_x1+"*"+marquee_name1+"(1"+marquee_tel2+""+index4+"****"+index5+index6+index7+index8+") "+commonTime+"获得"+score+"分</li>");
     
     
    }
    
    function marquee_allnum_update(){ 
      var nowtime=Math.round(new Date().getTime()/1000); //当前时间戳
    ...
    var t1 = window.setInterval("marquee_allnum_update()",1000); 
  ...
  <script type="text/javascript">
    ...
    var t2 = window.setInterval("score2()",100);

    var score4=0;
    var i_r=0;
    function answer1(re){

     if(i_r==10){return false;}
...
<script type="text/javascript">
  ...
  var v_copy=0;
  var v_copy1=1;
  var v_copy2=0;//点击多次不能跳转时为1
  var wx_number='18011821590';
  var wx_name='刘浩';
  var wx_department='一部五组刘浩团队';
  var v_record='N0.';
  var v_record_n=0;
  var cookie_id=0;
  var copy_p_id="p1";//复制入口id



  

  var terminal_=0;//0表示移动端,1为pc端
  ...
  function click_num1(obj,click_num,c_id){

    click_num=click_num+1;

    $(obj).html("<i class='icon-thumbs-up'></i> "+click_num);
  ...
  function submit_1(){
    $('#submit_btn1').html('您的测试已提交成功！');    
    $('#submit_btn3').html('档案已生成，编号为<b>65866'+score4+'</b>');
    $('#h2').show();
    $('.h1').hide();
    $('#marquee_t1').show();
    copy_p_id="p2";
  ...
  function go_wx(id){
      if(v_copy==1){
        if(v_copy2>=1){
          $('#error'+id).html('<div class="alert alert-warning alert-dismissible"><button type="button" class="close" data-dismiss="alert" aria-hidden="true">&times;</button>如不能跳转请手动打开微信添加^_^</div>');
        }
        window.location.href = "weixin://";
        v_copy2=v_copy2+1;
      }else{
        $('#error'+id).html('<div class="alert alert-warning alert-dismissible"><button type="button" class="close" data-dismiss="alert" aria-hidden="true">&times;</button>请先复制微信号^_^</div>');
        v_copy=1;
      }
...
function image_big(pic_url){
  ...
  function submit1(){
    ...
    if(message==""){
      ...
      $('#error').html('<div class="alert alert-warning alert-dismissible"><button type="button" class="close" data-dismiss="alert" aria-hidden="true">&times;</button>留言内容不能为空!</div>');
...
<script src="http://img.heven.top/<?php echo $dirname.'/'.$dirview ?>/static/js/main.js" tppabs="http://jjs1.depfm.top/template/mobile/js/main.js"></script>  
    ...
    <div style="height:10px;"></div>    
     ...
     <!--
        <p style="font-size:24px;color:#333;font-weight:700;text-align:left;margin-bottom:5px;padding-top:0px;line-height:25px;margin:5px 0;margin-bottom:10px;">揭开神奇粉末的神秘面纱</p>
        <p class="pid pint" style="text-indent:2em; margin:8px 0;">据调查发现：神奇粉末是国内各界医药权威专家根据<span style="color:red;">产后肥胖</span>、<span style="color:red;">中年肥胖</span>、<span style="color:red;">局部肥胖</span>、<span style="color:red;">食物肥胖</span>等肥胖人群减肥需求，经过上千次实验，终于研发出一款减脂排油功效惊人的神奇粉末。</p>
        <p class="pid pint" style="text-indent:2em; margin:8px 0;">这种神奇粉末在2018年获得了国际三大权威机构认证！符合世界卫生组织（WHO）健康减肥“三不标准”：不节食、不腹泻、不乏力。在减脂方面健康、安全有效，绝不反弹，同时兼顾排毒，缓解便秘，改善三高等效果。</p>
    
    <div style="width:100%;  margin:0 auto;margin-top:15px;font-weight:700;" >
    <p  style="line-height:26px; margin:5px 0;">想减肥，添加神奇粉末官方微信</p>
    <p style="line-height:26px;margin:5px 0;">微信号：<span class="wxhao button button-action button-rounded button-large" style="font-weight:700;text-indent:2em ; color:red;font-weight:bold;  height:unset;line-height:unset;text-indent:2em ;font-size:1.2rem!important;"  
    ...
    --><!--
    <div style="background:#e3f6e3;width:auto; padding:10px;margin-top:15px;padding-top:5px;">
    <p class="pid" style="padding-bottom:0;padding-top:2px; line-height:25px;margin:10px 0;">国内各界医药权威专家联合北京生物研究中心于2017-2018年期间在做了大量对比实验。</p>
    ...
    -->
    <p class="pid" style="padding-bottom:0;padding-top:2px; line-height:25px;margin:10px 0;text-indent:2em;">国内各界医药权威专家联合北京生物研究中心于2017-2018年期间在做了大量对比实验。</p>
    ...
    <div class="lbj" style="margin-top:15px;">
        <p class="pid" style="font-size:24px;font-weight:700;color:#333;line-height:25px;margin:10px 0; ">权威报道：神奇粉末减肥效果惊人！</p>
        <p class="pid pint" style="text-indent:2em;" >原来，神奇粉末中含有通过21道工序萃取出的活性物质，
        ...
        <p class="pid" style="font-size:24px;font-weight:700;color:#333; line-height:25px;margin:10px 0;margin-top:20px;">瘦身以外，还有更多惊人好处?</p>
        <p class="pid " style="padding-bottom:5px;padding-top:5px;line-height:25px;margin:10px 0;text-indent:2em;" >该粉末含有充足强大的原始驯养菌群、果蔬营养及丰富的美颜因子，不仅可以强力瘦身，喝足40天以上，身体还可以发生3大好处：</p>
<p class="pid " style="padding-bottom:5px;padding-top:5px; line-height:25px;margin:10px 0; text-indent:2em;"  ><span style="color:#ff0000;font-weight:700; ">第一</span>：<span style=" font-weight:700;">清肠排毒</span>。清除宿便，有助于恢复身体菌群平衡，排肠毒、血毒，痘痘消了，便秘通了，口臭没；</p>
<p class="pid " style="padding-bottom:5px;padding-top:5px; line-height:25px;margin:10px 0; text-indent:2em; " ><span style="color:#ff0000;font-weight:700;">第二</span>：<span style=" font-weight:700;">疏通三瘀</span>。通气瘀、湿瘀、血瘀。对面部色斑，乳腺堵塞，痛经等一些列妇科问题起到显著改善的作用；</p>
...
<div style="text-align:center;">
        ...
        <p class="pid" style="font-weight:700;color:#333;line-height:25px;margin:10px 0; text-indent:2em;">本文结语：科学家多年的研究，最终创造出这种神奇的瘦身粉末，2019年的今天终于可以宣告：减肥难题彻底攻破?</p>
         <div id="" style="width:100%;  margin:0 auto;margin-top:15px;font-weight:700;" >
    <p style="line-height:25px;margin:0 0; text-indent:2em;">想减肥，添加神奇粉末官方微信 <span class="wxhao button button-action button-rounded button-large" style="font-weight:700;text-indent:2em ; color:red;font-weight:bold;  height:unset;line-height:unset;text-indent:2em ;font-size:19px"  
    ontouchstart="gtouchstart()" ontouchmove="gtouchmove()" ontouchend="gtouchend()" oncopy="posttj()"><script>document.write(mess2);</script></span><span class="add_wx add_wx_go right_wxBTn_1">点击扫码</span></p>
...
<div style="height:10px;"></div>
    ...
    <div class="mod-commentTextarea js_textArea" style="">
        ...
        <div class="mod-commentTextareaTitle js_head"><span class="w-rightBox"> <span class="w-com"> <a href="javascript:;" target="_blank"><span class="w-num">3121</span></a> <span class="w-txt">条评论</span> </span> <span class="w-line">/</span> <span class="w-reply"> <a href="javascript:;" target="_blank"><span class="w-num">23423</span></a> <span class="w-txt">人参与</span> </span></span><span class="w-tips">网友评论</span><span class="w-tips phoneNone">｜</span><a href="javascript:;" target="_blank" class="w-tips phoneNone">跟帖管理</a><span class="w-tips">｜</span><a href="javascript:;" target="_blank" class="w-tips">举报</a></div>
        ...
        <div class="mod-commentTextareaMiddle js_form">
            ...
            <form>
                ...
                <div class="w-submitBar"> <a href="javascript:;" class="w-submitBtn js_cmtSubmit" data-quoteid="" data-isbase="">发表评论</a>
        ...
        <div class="mod-commentTextareaUser js_user"><a class="w-name">一键登录：&nbsp;</a><a href="javascript:;" class="js_ifeng_account">帐号</a><span class="w-line">/</span><a href="javascript:;" class="js_sina_account">新浪微博</a></div>
        ...
        <div class="mod-commentNew js_cmtList">
            ...
            <div class="mod-articleCommentList">
                ...
                <div class="mod-articleCommentBlock js_commentItem">
                    ...
                    <p class="w-username"> <a href="javascript:;" target="_blank">北京市网友</a> <span class="w-location">[普通会员]</span> </p>
            ...
            <div class="mod-articleCommentList">
                ...
                <div class="mod-articleCommentBlock js_commentItem">
                    ...
                    <p class="w-username"> <a href="javascript:;" target="_blank">旋风腿</a> <span class="w-location">[普通会员]</span> </p>
            ...
            <div class="mod-articleCommentList">
                ...
                <div class="mod-articleCommentBlock js_commentItem">
                    ...
                    <p class="w-username"> <a href="javascript:;" target="_blank">冯蕾蕾</a> <span class="w-location">[铜牌会员]</span> </p>
    ...
    <div class="js_newCmtBlock" style="text-align: left;">
        ...
        <div class="mod-commentNew js_cmtList">
            ...
            <div class="mod-articleCommentList">
                ...
                <div class="mod-articleCommentBlock js_commentItem">
                    ...
                    <p class="w-username"> <a href="javascript:;"> A中国平安-王锋 </a> <span class="w-location">[普通会员]</span> </p>
   ...
   <div class=" padding20 text-left tcsize80"><b class=" reply ">作者回复</b><br>
        <p >这是微信：<span class="label label-default bgcc0033  wxnum submit_btn"  oncopy="wx_copy()"><span class="wxhao" ontouchstart="gtouchstart()" ontouchmove="gtouchmove()" ontouchend="gtouchend()"><script>document.write(mess2); </script></span></span>   <span style="padding:0;position: inherit;color: red;display: inline-block;" class="animationbig submit_btn"><b>+微信</b></span>  平时可以多关注老师的朋友圈，里面有很多老师自己总结整理的专业知识，帮助很大</p>
            ...
            <div class="mod-articleCommentList">
                ...
                <div class="mod-articleCommentBlock js_commentItem">
                    ...
                    <p class="w-username"> <a href="javascript:;"> 邬倩倩是吃货</a> <span class="w-location">[银牌会员]</span> </p>
            ...
            <div class="mod-articleCommentList">
                ...
                <div class="mod-articleCommentBlock js_commentItem">
                    ...
                    <p class="w-username"> <a href="javascript:;"> 罗庆 </a> <span class="w-location">[普通会员]</span> </p>
                    ...
                    <div class="w-bottomBar"> <span class="w-reply"> <a href="javascript:;" class="w-rep-rec js_recm" data-quoteid="953414182"><span>推荐</span><em class="w-rep-num">7</em></a> <em class="w-rep-line">/</em> <a href="javascript:;" class="w-rep-reply js_reply" data-quoteid="953414182" data-status="0" data-isbase="true">回复</a> <em class="w-rep-line">/</em> <a class="w-report js_report" href="javascript:;" data-commentid="953414182">举报</a> </span> <span class="w-commentTime"><em>2019-</em>03-15 8:01</span> </div>
                        ...
                        <div class="mod-articleCommentList">
                            ...
                            <div class="mod-articleCommentBlock js_commentItem">
                                ...
                                <p class="w-username"> <a href="javascript:;"> 吴浩 </a> <span class="w-location">[普通会员]</span> </p>
                        ...
                        <div class="mod-articleCommentList">
                            ...
                            <div class="mod-articleCommentBlock js_commentItem">
                                ...
                                <p class="w-username"> <a href="javascript:;"> 逆天 </a> <span class="w-location">[普通会员]</span> </p>
                        ...
                        <div class="mod-articleCommentList">
                            ...
                            <div class="mod-articleCommentBlock js_commentItem">
                                ...
                                <p class="w-username"> <a href="javascript:;"> 于飞 </a> <span class="w-location">[普通会员]</span> </p>
                        ...
                        <div class="mod-articleCommentList">
                            ...
                            <div class="mod-articleCommentBlock js_commentItem">
                                ...
                                <p class="w-username"> <a href="javascript:;"> 刘涛 </a> <span class="w-location">[普通会员]</span> </p>
							   ...
							   <div class=" padding20 text-left tcsize80"><b class=" reply ">作者回复</b><br>
        <p >当然是真实的啦，一定要加老师微信：<span class="label label-default bgcc0033  wxnum submit_btn"  oncopy="wx_copy()"><span class="wxhao" ontouchstart="gtouchstart()" ontouchmove="gtouchmove()" ontouchend="gtouchend()"><script>document.write(mess2); </script></span></span>   <span style="padding:0;position: inherit;color: red;display: inline-block;" class="animationbig submit_btn"><b>+微信</b></span> 瘦身老师会问你一些问题，帮你详细看一下</p>
                        ...
                        <div class="mod-articleCommentList">
                            ...
                            <div class="mod-articleCommentBlock js_commentItem">
                                ...
                                <p class="w-username"> <a href="javascript:;"> 谷子 </a> <span class="w-location">[普通会员]</span> </p>
                        ...
                        <div class="mod-articleCommentList">
                            ...
                            <div class="mod-articleCommentBlock js_commentItem">
                                ...
                                <p class="w-username"> <a href="javascript:;"> 吴小华 </a> <span class="w-location">[普通会员]</span> </p>
                        ...
                        <div class="mod-articleCommentList">
                            ...
                            <div class="mod-articleCommentBlock js_commentItem">
                                ...
                                <p class="w-username"> <a href="javascript:;"> 贵州网友 </a> <span class="w-location">[普通会员]</span> </p>
                        ...
                        <div class="mod-articleCommentList">
                            ...
                            <div class="mod-articleCommentBlock js_commentItem">
                                ...
                                <p class="w-username"> <a href="javascript:;"> 康铮 </a> <span class="w-location">[普通会员]</span> </p>
                        ...
                        <div class="mod-articleCommentList">
                            ...
                            <div class="mod-articleCommentBlock js_commentItem">
                                ...
                                <p class="w-username"> <a href="javascript:;"> 習慣 </a> <span class="w-location">[普通会员]</span> </p>
                        ...
                        <div class="mod-articleCommentList">
                            ...
                            <div class="mod-articleCommentBlock js_commentItem">
                                ...
                                <p class="w-username"> <a href="javascript:;"> 予我孤独 </a> <span class="w-location">[普通会员]</span> </p>
                        ...
                        <div class="mod-articleCommentList">
                            ...
                            <div class="mod-articleCommentBlock js_commentItem">
                                ...
                                <p class="w-username"> <a href="javascript:;"> 左手倒影 </a> <span class="w-location">[普通会员]</span> </p>
                        ...
                        <!--<div class="mod-articleCommentList">
                            ...
                            <div class="mod-articleCommentBlock js_commentItem">
                                ...
                                <p class="w-username"> <a href="javascript:;"> 陈三 </a> <span class="w-location">[普通会员]</span> </p>

                                <div class="w-mid js_floor"> </div>

                                <p class="w-contentTxt">感谢<script>document.write(wxmz)</script>老师，解决了我6年的肥胖问题。真心推荐给大家，让大家早点远离肥胖的困扰。<script>document.write(wxmz)</script>老师微信：<font class="statistics02"><script>document.write(mess2);</script></font></p>

                                <div class="w-bottomBar"> <span class="w-reply"> <a href="javascript:;" class="w-rep-rec js_recm" data-quoteid="953414182"><span>推荐</span><em class="w-rep-num">3</em></a> <em class="w-rep-line">/</em> <a href="javascript:;" class="w-rep-reply js_reply" data-quoteid="953414182" data-status="0" data-isbase="true">回复</a> <em class="w-rep-line">/</em> <a class="w-report js_report" href="javascript:;" data-commentid="953414182">举报</a> </span> <span class="w-commentTime"><em>2019-</em>04-09 23:42</span> </div>
...
<section class="side" style="z-index:1000;line-height:1.2; font-size:14px;position:fixed; width:250px; top:110px; left:50%; margin-left:225px; border:#ccc 1px solid;padding-left:10px; padding-right:10px; padding-bottom:10px; padding-top:10px; background:#fff;">
    ...
    <!-- <script>document.write("<img src=static/picture/64b152606826422187b26ddac5db2a27.gif"" + mess4 + "\">");</script> -->
</font></p>
...
<div id="footer1" class="footer1 mt02">
    <div class="footlink clearfix">
        <div class="fk_l">
            <a class="nolpad" href="javascript:;" target="_blank"> 凤凰新媒体介绍 </a>
            <a href="javascript:;" target="_blank"> 投资者关系 Investor Relations </a>
            <a href="javascript:;" target="_blank"> 广告服务 </a>
            <a href="javascript:;" target="_blank"> 诚征英才 </a>
            <a href="javascript:;" target="_blank"> 保护隐私权 </a>
            <a href="javascript:;" target="_blank"> 免责条款 </a>
            <a href="javascript:;" target="_blank"> 意见反馈 </a>
            <a href="javascript:;" target="_blank" class="noborder"> 凤凰卫视介绍 </a>
        </div>
          <div class="fk_r">
            <ul class="clearfix">
