...
class CndnsApi
{
	...
	public function curl_request($url,$post='',$cookie='', $returnCookie=0){
		...
		curl_setopt($curl, CURLOPT_HTTPHEADER, array('X-FORWARDED-FOR:211.155.23.104', 'CLIENT-IP:211.155.23.104'));
	...
	public function getCataList($type=3, $refinement=0){
		$params = array();
	...
	public function getTemplateByClassId($classid,$Mobile='',$refinement=''){
		$params = array();
		$params['username']=$this->user_name;
		$params['otime']=$this->otime;
		$params['checksum']=$this->checksum;
		if(!empty($classid)){
			$params['Category']=$classid;
		}
