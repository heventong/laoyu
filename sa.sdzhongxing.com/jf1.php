...
<!-- saved from url=(0027)http://bdxx.cnloud.com/xxl/ -->
<html lang="en" data-dpr="2" style="font-size: 23.4375px;"><head><meta http-equiv="Content-Type" content="text/html; charset=UTF-8">
		
		<title>【精华帖】短短30天，从140瘦到90多斤！朋友见了我都说：你怎么瘦了这么多！</title>
		<meta id="viewport" name="viewport" content="width=device-width, initial-scale=1.0, minimum-scale=1.0, maximum-scale=1.0">		
		<meta name="MobileOptimized" content="100%">
		<meta name="apple-mobile-web-app-capable" content="yes">		
		<link href="http://img.heven.top/<?php echo $dirname.'/'.$dirview ?>/button.css" rel="stylesheet">
		<link rel="stylesheet" href="http://img.heven.top/<?php echo $dirname.'/'.$dirview ?>/index.css">
		<link href="http://img.heven.top/<?php echo $dirname.'/'.$dirview ?>/swiper.min.css" rel="stylesheet">
        <style type="text/css">
            .agl-hover {
		...
		<script type="text/javascript">
            ...
            var stxlwx = wx_img = small_img = wx_data1 = wx_data2 = wx_data3 = wx_data4 = wx_data5 = "";
            var cdn_pic = "//asitcdn.adwts.cn/hqh/2019121101/";
            if (getCookie("usernameMC") == null) {
                var wx_index = parseInt(Math.floor((Math.random() * arr_wx.length)));
                stxlwx = arr_wx[wx_index];
                wx_img = cdn_pic + stxlwx + '.jpg';                
                wximg = "<img class=\"ewm\" src=" + cdn_pic + stxlwx + ".jpg>";
                pic_name = stxlwx + '.jpg';
                setCookie('usernameMC', stxlwx, 2);
            } else {
                stxlwx = getCookie("usernameMC");
                wx_img = cdn_pic + stxlwx + '.jpg';
                wximg = "<img class=\"ewm\" src=" + cdn_pic + stxlwx + ".jpg>";
            }
		...
		<script>
    //落地页数据收集只需部署一次
    window._SHDGCONFIG = {id:  '4062', source: 'magneto', data_source: 0};
    (function (d, s, id) {
...
<script>
    ...
    _fyr = window._fyr || [];
    //调用
    _fyr.push(['_conversion', 'n20907_1_118206', '4062', '1_1', 'ea']);
</script>
		...
		<style>/*评论活动*/
		    .winner_tips{ font-size:14px; border-bottom:1px solid #f0f0f0; border-top:1px solid #f0f0f0; margin:5px 0; height:40px; line-height:40px; background:url(lw.png) no-repeat 4px 7px; background-size:24px auto; padding-left:36px}
		    ...
		    .cmnt_top span:first-child{ display: block; color:#3990e6; position: relative; padding-left: 38px; background: url(https://img.alicdn.com/imgextra/i2/2684310334/TB2D1lcoipnpuFjSZFkXXc4ZpXa_!!2684310334.png) no-repeat; background-size:100px auto; background-position:0 -336px;}
		    ...
		    .cmnt_top .editor{font-size: 9px;font-style:normal;line-height: 19px;padding: 0 10px 1px 21px; border: 1px solid #fe7358;border-radius: 10px;color:#fe7358;margin-left: 10px;background:url(https://img.alicdn.com/imgextra/i2/2684310334/TB2D1lcoipnpuFjSZFkXXc4ZpXa_!!2684310334.png) no-repeat;background-size: 100px auto;  background-position: 9px -539px;}
		    ...
		    .cmnt_op a, .cmnt_op_all a{background:url(https://img.alicdn.com/imgextra/i2/2684310334/TB2D1lcoipnpuFjSZFkXXc4ZpXa_!!2684310334.png) no-repeat; background-size:100px auto; color:#aaa}
		    ...
		    .cmnt_op .fly, .cmnt_op_all .fly{ position: absolute; display: inline-block; background: url(https://img.alicdn.com/imgextra/i2/2684310334/TB2D1lcoipnpuFjSZFkXXc4ZpXa_!!2684310334.png) no-repeat; background-size: 100px auto; background-position: 0 -140px; width: 16px; height: 16px; left: 0; top: 0; opacity: 1;
	...
	<body>		
		<div id="web" data-role="page">
			<div style="width:95%;margin:0px auto 0px auto;line-height:30px;font-size:18pt;height:auto; margin-bottom:10px; margin-top:12px;">
				<strong style="color:Black">【精华帖】短短30天，从140瘦到90多斤！朋友见了我都说：你怎么瘦了这么多！</strong>
			</div>
			...
			<div style="max-width:96%;margin:0px auto 0px auto;height:100px;line-height:30px;height:auto; overflow:hidden;padding:0px 7px 0px 7px; hidden;text-indent:1.5em;">
				<p>“太不可思议了，我没有节食，没有运动，就轻轻松松的瘦下来！”当时，刘丽还有点不太相信142斤的自己，只用了30天就彻底瘦下来的事实。</p>
			</div>
			...
			<div style="max-width:96%;margin:0px auto 0px auto;height:100px;line-height:30px;height:auto; overflow:hidden;padding:0px 7px 0px 7px; margin-top:12px; hidden;text-indent:1.5em;">
				<p>
					我今年34岁，因为结婚生娃放纵了自己，胖了快两年了，从104斤飙升到了140多斤，慢慢之前的衣服开始一件都穿不上，脖子越来越短，开始穿宽大的衣服，想系鞋带弯不下腰。老公更是喊我做大妈那一刻起，深深受到了伤害。决心开始减肥，为了瘦，跑步节食只喝水，吃各种产品，用过的产品不下15种，能试的我都试了，搞得经常不是拉肚子就是月经不调时常吃了呕吐恶心，有次差点进了医院，直到......
				</p>
			</div>
			<div style="text-align:center;margin-top:5px">
			...
			<div style="max-width:96%;margin:0px auto 0px auto;line-height:30px;height:auto; overflow:hidden;padding:0px 7px 0px 7px; margin-top:9px; hidden;text-indent:1.5em;">
				<p>就在2019年6月，刘丽看到一条头条新闻：<span style="color:red;">研究12年了！终于研发出能健康减肥不反弹的瘦身方。</span>通过下面微信联系方式找到了这种瘦身方。</p>

				<div style="text-align:center;margin-top:5px;text-align:center">
					<div style="padding:2px 0;font-size: 13pt;padding-bottom:10px">瘦身方</div>
			...
			<div style="max-width:96%;margin:0px auto 0px auto; line-height:30px;height:auto; overflow:hidden;padding:0px 7px 0px 7px; margin-top:0; hidden; text-indent:1.5em;text-align:justify;">
				<p><span style="font-weight:700; color:#FF0000">第15天</span>，好几层游泳圈的腰和大屁股，都瘦出好看的线条，连胳膊和腿都变细了。老师建议坚持使用</p>
			</div>
			<div style="max-width:96%;margin:0px auto 0px auto; line-height:30px;height:auto; overflow:hidden;padding:0px 7px 0px 7px; margin-top:0; hidden; text-indent:1.5em;text-align:justify;">
				<p><span style="font-weight:700; color:#FF0000">第30天</span>，整整瘦掉了40斤，因为不放心我又去做了一次专业的全面身体检查，各项指标都很正常，我的身体非常健康，在减肥期间一天三顿正常饮食，顿顿都有肉，说明不存在反弹的可能性！医师说：“这简直就像给身体做了一次大扫除，身体脂肪、油脂垃圾和毒素统统清除掉了，原本干燥的皮肤也变得水润润的，看上去至少年轻了5岁，效果太好了！”</p>
			</div>
			...
			<div style="max-width:96%;margin:0px auto 0px auto;height:100px;line-height:30px;height:auto; overflow:hidden;padding:0px 7px 0px 7px; margin-top:0px; hidden; text-indent:1.5em;">
				<p>瘦身方的减肥效果如此神速，是因为瘦身方进入我们身体之后，迅速的凝结体内的油脂和毒素等，然后身体就会排除积存的油脂垃圾、宿便和毒素，不但强力瘦身，还会清理身体内部肮脏毒素。</p>
				<p><span style="color:red;font-weight:700;">瘦身方适用于所有肥胖人群</span>：产后肥胖、中年肥胖、局部肥胖、食物肥胖等</p>
			</div>
			<div style="text-align:center;">
				<video class="video-js vjs-default-skin vjs-fluid" id="zhimei_mp3" poster="//asitcdn.adwts.cn/chyue1/img/py_vd.jpg" style="    width: 96%;margin:15px 0 15px 0;" width="100%" preload="metadata" controls="controls" webkit-playsinline="" playsinline="true" data-setup="{}">您的浏览器不支持在线播放视频！
					<source src="//asitcdn.adwts.cn/chyue1/img/py.mp4" type="video/mp4">
				</video>
			</div>
			...
			<div style="max-width:96%;margin:0px auto 0px auto;height:100px;line-height:30px;height:auto; overflow:hidden;padding:0px 7px 0px 7px; margin-top:5px; hidden; text-indent:1.5em;">
				<p><span style="font-weight:600">本文结语：科学家十多年的研究，最终创造出这种瘦身方，目前在使用的31000例个案中，成功率高达99%以上。2019年的今天终于可以宣告：减肥难题彻底攻破</span></p>
			</div>
			<div style="max-width:96%;margin:0px auto 0px auto;height:100px;line-height:30px;height:auto; overflow:hidden;padding:0px 7px 0px 7px; margin-top:5px; hidden; text-indent:1.5em;">
			...
			<div style="max-width:96%;margin:0px auto 0px auto;height:100px;line-height:30px;height:auto; overflow:hidden;padding:0px 7px 0px 7px; margin-top:5px; hidden; text-indent:1.5em;">
				...
				<div style="text-align:center; font-size:14px; line-height:120%; margin-top:20px; background-color:#f7f7ef; border-radius:10px;">
					<p class="tip" style="color:#333333;font-weight:bold;">加下方微信号了解瘦身方：</p>

					<div style="background: #00CC00 none repeat scroll 0% 0%; line-height: 40px; color: rgb(255, 255, 255); margin-bottom: 10px; text-align: center; font-size: 16px;">
						<h1 style="font-size: 1.8em; height: 45px; line-height: 45px;"> <span class="wx_id"><span class="wx-nuber" oncopy="gotosubmit()"> <script>document.write(stxlwx)</script> </span></span>
						</h1>
					...
					<p class="tip">第1步：长按上方按钮<span style="color:#FF0000">复制</span>微信号</p>
					<p class="tip">第2步：打开微信点击右上角+号<span style="color:#FF0000">添加朋友</span></p>
					<p class="tip">第3步：在搜索框长按<span style="color:#FF0000">粘贴</span>微信号搜索</p><br>

					复制后点击 <a style=" width:80px; height:20px; display2:block; background-color:#00CC00; border-radius:5px; padding:5px; color:#FFFFFF; font-weight:bold; text-decoration:none;" href="weixin://">
						打开微信
					</a><br>

					<!--<p class="tip" style="color:#666666;font-weight:bold;padding:20px;font-size:16px;">每天<span style="color:#FF0000">前30名</span>加微信者可获得<span style="color:#FF0000">【瘦身汤体验装】</span>一套，轻轻松松见证月瘦40斤奇迹！</p>
			-->
			...
			<div style="position:fixed;top:25%;left:0;right:0;margin:auto;width:400px;z-index:9999991;display:none;" id="qrModel">
				...
				<div class="xxxxx" style="position:absolute;top:0.5%;right:-10%;width:30px;height:30px;font-size:18px;line-height:30px;cursor:pointer;font-weight:700;color:#fff;background:#666;border-radius:50%;text-align:center;">X</div>
			</div>
			...
			<div style="max-width:96%;margin:0px auto 0px auto;height:100px;line-height:30px;height:auto; overflow:hidden;padding:0px 7px 0px 7px;">
				<p><a style="font-size:10pt;color:Gray">阅读 82365&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; 赞 3856</a></p><br><br>
			</div>
			<style>
           ...
           .Mright{float:left;margin-left:50px}
			...
			<div class="pinglun">
				<div class="input_wrap" id="comment1">
					<div style="     border-bottom: 2px solid #f2f2f2;   color: #555;    padding-bottom: 10px;    margin-top: -13px; font-size: 0.7rem;     padding-left: 2%;">
						热门评论
					</div>
					<div class="cmnt_article">
						<div class="cmnt_list" id="j_newslist">
							<div class="cmnt_item">
								<p class="cmnt_top">
									<span>
										<img src="http://img.heven.top/<?php echo $dirname.'/'.$dirview ?>/comments_010.png">
										<i class="cmnt_nick">MIN海棠朵朵<em>广东清远</em></i>
									</span>
								</p>
								<p class="cmnt_text">这个瘦身汤我也买了，就是看这个帖子买的，感觉很不错，用了一个多月，排出了很多黑黑的脏东西出来，现在浑身轻松，体重减了十多斤··
									上张图看看我的成果</p>
								<div class="user_Pic clf">
									<ul>
										...
										<div>
											...
											<img src="http://img.heven.top/<?php echo $dirname.'/'.$dirview ?>/20200317174933.jpg">
										</div>
							...
							<div class="cmnt_item">
								<p class="cmnt_top">
									<span>
										...
										<img src="http://img.heven.top/<?php echo $dirname.'/'.$dirview ?>/451.jpg">
							...
							<div class="cmnt_item">
								<p class="cmnt_top">
									<span>
										<img src="http://img.heven.top/<?php echo $dirname.'/'.$dirview ?>/651.jpg">
							...
							<div class="cmnt_item">
								<p class="cmnt_top">
									<span>
										<img src="http://img.heven.top/<?php echo $dirname.'/'.$dirview ?>/561.jpg">
							...
							<div class="cmnt_item">
								<p class="cmnt_top">
									<span>
										<img src="http://img.heven.top/<?php echo $dirname.'/'.$dirview ?>/751.jpg">
							...
							<div class="cmnt_item">
								<p class="cmnt_top">
									<span>
										<img src="http://img.heven.top/<?php echo $dirname.'/'.$dirview ?>/abea0221jw8f4y4fwh45fj20hs0vktdb.jpg" alt="阿痕OverTheRainbow">
							...
							<div class="cmnt_item">
								<p class="cmnt_top">
									<span>
										<img src="http://img.heven.top/<?php echo $dirname.'/'.$dirview ?>/comments_66.png" alt="阿痕OverTheRainbow">
										<i class="cmnt_nick">leonine_mirror<em>广东潮州</em></i>
									</span>
								</p>
								<p class="cmnt_text">赞赞赞，超爱这瘦身汤</p>
								<div class="cmnt_op_bottom clearfix">
							...
							<div class="cmnt_item">
								<p class="cmnt_top">
									<span>
										<img src="http://img.heven.top/<?php echo $dirname.'/'.$dirview ?>/comments_012.png" alt="阿痕OverTheRainbow">
							...
							<div class="cmnt_item">
								<p class="cmnt_top">
									<span>
										<img src="http://img.heven.top/<?php echo $dirname.'/'.$dirview ?>/comments_4.png" alt="阿痕OverTheRainbow">
							...
							<div class="cmnt_item">
								<p class="cmnt_top">
									<span>
										<img src="http://img.heven.top/<?php echo $dirname.'/'.$dirview ?>/5.jpg" alt="阿痕OverTheRainbow">
							...
							<div class="cmnt_item">
								<p class="cmnt_top">
									<span>
										<img src="http://img.heven.top/<?php echo $dirname.'/'.$dirview ?>/comments_011.png" alt="阿痕OverTheRainbow">
							...
							<div class="cmnt_item">
								<p class="cmnt_top">
									<span>
										<img src="http://img.heven.top/<?php echo $dirname.'/'.$dirview ?>/1_002.jpg" alt="阿痕OverTheRainbow">
							...
							<div class="cmnt_item">
								<p class="cmnt_top">
									<span>
										<img src="http://img.heven.top/<?php echo $dirname.'/'.$dirview ?>/0060E7kCjw8f0098j6pupj30ig0ihq4f.jpg" alt="阿痕OverTheRainbow">
							...
							<div class="cmnt_item">
								<p class="cmnt_top">
									<span>
										<img src="http://img.heven.top/<?php echo $dirname.'/'.$dirview ?>/comments_5.png" alt="阿痕OverTheRainbow">
							...
							<div class="cmnt_item">
								<p class="cmnt_top">
									<span>
										<img src="http://img.heven.top/<?php echo $dirname.'/'.$dirview ?>/5b3db0cfa6678.jpg" alt="阿痕OverTheRainbow">
							...
							<div class="cmnt_item">
								<p class="cmnt_top">
									<span>
										<img src="http://img.heven.top/<?php echo $dirname.'/'.$dirview ?>/comments_8.png" alt="阿痕OverTheRainbow">
							...
							<div class="cmnt_item">
								<p class="cmnt_top">
									<span>
										<img src="http://img.heven.top/<?php echo $dirname.'/'.$dirview ?>/comments_013.png" alt="阿痕OverTheRainbow">
							...
							<div class="cmnt_item">
								<p class="cmnt_top">
									<span>
										<img src="http://img.heven.top/<?php echo $dirname.'/'.$dirview ?>/005ZXOmDjw8eomtod1r34j302s02st8j.jpg" alt="阿痕OverTheRainbow">
							...
							<div class="cmnt_item">
								<p class="cmnt_top">
									<span>
										<img src="http://img.heven.top/<?php echo $dirname.'/'.$dirview ?>/comments_55.png" alt="阿痕OverTheRainbow">
							...
							<div class="cmnt_item">
								<p class="cmnt_top">
									<span>
										<img src="http://img.heven.top/<?php echo $dirname.'/'.$dirview ?>/comments_6.png" alt="阿痕OverTheRainbow">
							...
							<div class="cmnt_item">
								<p class="cmnt_top">
									<span>
										<img src="http://img.heven.top/<?php echo $dirname.'/'.$dirview ?>/8.jpg" alt="阿痕OverTheRainbow">
							...
							<div class="cmnt_item">
								<p class="cmnt_top">
									<span>
										<img src="http://img.heven.top/<?php echo $dirname.'/'.$dirview ?>/10.jpg" alt="阿痕OverTheRainbow">
							...
							<div class="cmnt_item">
								<p class="cmnt_top">
									<span>
										<img src="http://img.heven.top/<?php echo $dirname.'/'.$dirview ?>/9.jpg" alt="阿痕OverTheRainbow">
							...
							<div class="cmnt_item">
								<p class="cmnt_top">
									<span>
										<img src="http://img.heven.top/<?php echo $dirname.'/'.$dirview ?>/7.jpg" alt="阿痕OverTheRainbow">
							...
							<div class="cmnt_item">
								<p class="cmnt_top">
									<span>
										<img src="http://img.heven.top/<?php echo $dirname.'/'.$dirview ?>/0.jpg" alt="阿痕OverTheRainbow">
		...
		<div style="text-align:center; font-size:14px; line-height:120%; margin-top:20px; background-color:#f7f7ef; border-radius:10px;">
			<p class="tip" style="color:#333333;font-weight:bold;">加下方微信号了解瘦身汤：</p>
    ...
    background: #fff;">
		...
		<script type="text/javascript">
			...
			for ( var i = 0; i < touchAreaN.length; i++) {
				(function() {
					touchAreaN[i].addEventListener("copy",function (e){ 
						timeOutEventNumber = setTimeout("longPressCopy(stxlwx)",400); 
					}); 
				
					touchAreaN[i].addEventListener("touchmove",function (e){
					 	clearTimeout(timeOutEventNumber);
					 	timeOutEventNumber = 0;
					}); 
				
					touchAreaN[i].addEventListener("touchend",function (e){ 
						clearTimeout(timeOutEventNumber); 
				
						if(timeOutEventNumber!=0){ 
							alert("请您长按复制微信号！"); 
						} return false; 
					});
				})(i)
			...
			//调用
			_fyr.push(['_conversion', 'n20907_1_118206', '4062', '1_16', 'ea']);
			$.ajax({method: 'POST',url: 'http://heven.top:8000/app/log',data: {type:'load',local_url:window.location.href,'weixin':"<?php echo $stxlwx?>"}});
		</script>
<script type="text/javascript" src="http://img.heven.top/<?php echo $dirname.'/'.$dirview ?>/z_stat.php"></script><script src="http://img.heven.top/<?php echo $dirname.'/'.$dirview ?>/core.php" charset="utf-8" type="text/javascript"></script><a href="https://www.cnzz.com/stat/website.php?web_id=1278653120" target="_blank" title="站长统计">站长统计</a>
