...
call admin()
	...
	sqls="select * from dingdan where id="&id
...
<td height="25" colspan="7" align="left" valign="top" background="Images/bg.jpg"  class="biaoti STYLE1">用户信息：</td>
      ...
      <tr>
        <td width="16%" height="30"  bgcolor="#FFFFFF">姓 　名： <%=rss("username")%> 　　  　 </td>
        <td width="13%"  bgcolor="#FFFFFF">手机：<%=rss("phone")%></td>
        <td width="6%"  bgcolor="#FFFFFF">性别：<%=rss("sex")%></td>
        <td width="7%"  bgcolor="#FFFFFF">年龄：<%=rss("age")%> </td>
        <td width="10%"  bgcolor="#FFFFFF"> 身高：<%=rss("height")%></td>
        <td height="25" colspan="2"  bgcolor="#FFFFFF">电话：<%=rss("dianhua")%></td>
      　      </tr>
      <tr>
        <td height="30" colspan="3"  bgcolor="#FFFFFF">收货地址：<%=rss("address")%></td>
        <td height="25"  bgcolor="#FFFFFF">邮编：</td>
        <td height="25" colspan="3"  bgcolor="#FFFFFF"><%=rss("code")%></td>
    </tr>
	<tr>
<td height="25" colspan="7" align="left" background="Images/bg.jpg"  class="biaoti STYLE1">订单信息：</td>
   ...
   <tr>
        <td height="30" colspan="3"  bgcolor="#FFFFFF">订购商品：<%=rss("product")%></td>                                                                                                                                                     
 <td height="25" align="left"  bgcolor="#FFFFFF">数量：<%=rss("num")%></td>
 <td height="25" colspan="3"  bgcolor="#FFFFFF"> 颜色：<%=rss("color")%> 　 </td>
 </tr>
	 <tr>
       <td height="30" colspan="2"  bgcolor="#FFFFFF">商品规格：<%=rss("guige")%> 　 </td>
 　                                                                                                                                                     
 <td height="25"  bgcolor="#FFFFFF">付款方式：</td>
 <td height="25"  bgcolor="#FFFFFF"><%=rss("pay")%></td>
 <td height="25"  bgcolor="#FFFFFF">&nbsp;</td>
 <td width="6%" height="25"  bgcolor="#FFFFFF">&nbsp;</td>
 <td width="42%" height="25"  bgcolor="#FFFFFF">&nbsp;</td>
    </tr>
	  	 <tr>
        <td height="30" colspan="7"  bgcolor="#FFFFFF">送货时间:<%=rss("send")%> 　 </td> 　      
        </tr>
	  	  	 <tr>
        <td height="30" colspan="7"  bgcolor="#FFFFFF">备注说明:<%=rss("beizhu")%> 　 </td> 　      
        </tr>
	  <tr>
<td height="25" colspan="7" align="left" background="Images/bg.jpg"  class="biaoti STYLE1">状态信息：</td>
    ...
    <tr>
      <td height="30" colspan="7"  bgcolor="#FFFFFF">发货时间：&nbsp;&nbsp;
